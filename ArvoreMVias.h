...
#pragma pack(push, 1)       // Controla o Alinhamento dos Campos
struct Registro {

    // ================================================================================================================
    // DECLARACAO DOS CAMPOS: (Aplicacao: Biblioteca)
    ...
    char genero[30];              // Genero do Livro
...
public:
    ...
    void insertB(int chave, const string& titulo, const string& autor,
                 int ano, const string& genero);                        // Insere Chave e Dados.
